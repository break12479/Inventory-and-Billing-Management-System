...
const handleAdd = async (fields: any) => {
    ...
    try {
        ...
        const fetchResponse = await fetch(
            "http://127.0.0.1:5000/api/createService",
            settings
        );
...
const getItems = async (param: any) => {
    ...
    try {
        const fetchResponse = await fetch(
            "http://127.0.0.1:5000/api/getServices?query_param=" + query
        );
        const data = await fetchResponse.json();
        // console.log(data)
...
const handleRemove = async (selectedRows: service[]) => {
    ...
    try {
        const fetchResponse = await fetch(
            "http://127.0.0.1:5000/api/deleteServices",
            settings
        );
        const data = await fetchResponse.json();
        hide();
        ...
        <>
            ...
            <ProTable<service, PageParams>
                ...
                request={(params, sorter, filter) => {
                    ...
                    getItems({ params, sorter }).then((result: any) => {
                        setData(result);
                        placeholder = result;
                    });
